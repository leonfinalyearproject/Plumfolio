...
// Exported so Edge Function callers can explicitly pass it as the `apikey`
// header — supabase-js doesn't reliably forward this header on .invoke()
// calls in some build configurations, causing a 401 at the gateway before

          ...
          <div className="scanner-modal-body">
            ...
            {extractedData && <div className="scan-result">
              ...
              <div className="scan-fields">
                ...
                <div className="scan-field-row"><div className="scan-field"><label>Date</label><input type="date" value={extractedData.date} onChange={e => setExtractedData({...extractedData, date: e.target.value})} /></div><div className="scan-field"><label>Total ({symbol})</label><div className="scan-amount-input"><span className="scan-currency-prefix">{symbol}</span><input type="number" step="0.01" value={extractedData.total} onChange={e => setExtractedData({...extractedData, total: parseFloat(e.target.value)||0})} /></div></div></div>

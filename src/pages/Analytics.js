...
const Analytics = () => {
  ...
  const { transactions, loading } = useInsights();
  ...
  return (
    <div className="analytics-page">
      <StaggerReveal className="analytics-summary" animation="up" stagger={80}>
      ...
      <div className="charts-grid">
        <ScrollReveal animation="up" delay={100} className="chart-card wide">
